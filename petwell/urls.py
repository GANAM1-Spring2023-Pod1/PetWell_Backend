...
from petwell_app.views import UserProfileViewSet, PetViewSet, AllPetsViewSet, IndividualPetViewSet, VaccineViewSet, MedicationViewSet, AllergyViewSet
